...
namespace mRemoteNG {
    ...
    internal class Language {
        ...
        /// <summary>
        ///   查找类似 An error occurred while trying to reconnect to RDP host &apos;{0}&apos; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An error occurred while trying to change the connection resolution to host &apos;{0}&apos; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Create a New Connection File 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use a Custom File Path 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Import an Existing File 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The connection file could not be found. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Could not find external tool with name &quot;{0}&quot; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Credential not available 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Database &apos;{0}&apos; not available. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Filter search matches in connection tree 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use UTF8 encoding for RDP &quot;Load Balance Info&quot; property 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Prompt to unlock credential repositories on startup 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The selected repository is unlocked 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Save connections after every edit 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Server &apos;{0}&apos; was not accessible. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 AddNodeFromXML failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 AddNodesFromSQL failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 AdvancedSecurityOptions 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Allow only a single instance of the application (mRemoteNG restart required) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Always connect, even if authentication fails 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Always show panel selection dialog when opening connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Always show panel tabs 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Always show notification area icon 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Ask me again later 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Customize the settings now 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use the recommended settings 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 {0} can automatically check for updates that may provide new features and bug fixes. It is recommended that you allow {0} to check for updates weekly. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Automatic update settings 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Assigned Credential 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Automatically get session information 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Auto save time in minutes (0 means disabled): 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Minutes (0 means disabled) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Default Inheritance 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Default Properties 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 You cannot import a normal connection file.
        ///Please use File - Open Connection File for normal connection files! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot start Port Scan, incorrect IP format! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Always show this screen at startup 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The (RDP) Sessions feature requires that you have a copy of eolwtscom.dll registered on your system.
        ...
        ///If this check still fails or you are unable to use the (RDP) Sessions feat [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 EOLWTSCOM was found and seems to be registered properly. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 To use the Gecko Rendering Engine you need to have XULrunner 1.8.1.x and the path to the installation set in your Options.
        ...
        ///If you are still not able to pass this check or use the Gecko Engine in mRemoteNG please c [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 GeckoFx was found and seems to be installed properly. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ICA requires that the XenDesktop Online Plugin is installed and that the wfica.ocx library is registered. You can download the client here: http://www.citrix.com/download/
        ///If you have the XenDesktop Online Plugin installed and the check still fails, try to register wfica.ocx manually.
        ///To do this open up the run dialog (Start - Run) and enter the following: regsvr32 &quot;c:\Program Files\Citrix\ICA Client\wfica.ocx&quot; (Where c:\Program Files\Citrix\ICA Client\ is the path to your XenDesktop Online Plugin install [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 All ICA components were found and seem to be registered properly.
        ///Citrix ICA Client Control Version {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 not installed properly 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The SSH, Telnet, Rlogin and RAW protocols need PuTTY to work. PuTTY comes with every mRemoteNG package and is located in the installation path.
        ///Please make sure that either you have the Putty.exe in your mRemoteNG directory (default: c:\Program Files\mRemoteNG\) or that you specified a valid path to your PuTTY executable in the Options (Tools - Options - Advanced - Custom PuTTY path) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The PuTTY executable was found and should be ready to use. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 For RDP to work properly you need to have at least Remote Desktop Connection (Terminal Services) Client 8.0 installed. You can download it here: http://support.microsoft.com/kb/925876
        ///If this check still fails or you are unable to use RDP, please consult the mRemoteNG Forum at {0}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 All RDP components were found and seem to be registered properly.
        ///Remote Desktop Connection Control Version {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC requires VncSharp.dll to be located in your mRemoteNG application folder.
        ...
        ///If you are still not able to pass this check or use VNC in mRemoteNG please consult the mRemoteNG Forum at {0}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 All VNC components were found and seem to be registered properly.
        ///VncSharp Control Version {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Automatically try to reconnect when disconnected from server (RDP &amp;&amp; ICA only) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Do not show this message again. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This proxy server requires authentication 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use custom PuTTY path: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Reconnect when ready 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use a proxy server to connect 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Check for updates at startup 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Check proper installation of components at startup 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose a path for the mRemoteNG log file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose panel before connecting 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Collapse all folders 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t parse command line args! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 &amp;Open a connection file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 {0} has detected the Lenovo Auto Scroll Utility running on this system. This utility is known to cause problems with {0}. It is recommended that you disable or uninstall it. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Compatibility problem detected 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 btnIcon_Click failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ShowHideGridItems failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 IconMenu_Click failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Property Grid object failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SetHostStatus failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 pGrid_PopertyValueChanged failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config UI load failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Do you want to close the connection:
        ///&quot;{0}&quot;? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to close the panel, &quot;{0}&quot;? Any connections that it contains will also be closed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the credential record, {0}? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the external tool, &quot;{0}&quot;? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the {0} selected external tools? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the connection, &quot;{0}&quot;? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the empty folder, &quot;{0}&quot;? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the folder, &quot;{0}&quot;? Any folders or connections that it contains will also be deleted. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to delete the selected node? 的本地化字符串。
        /// </summary>
        internal static string strConfirmDeleteNodeSelected {
            get {
                return ResourceManager.GetString("strConfirmDeleteNodeSelected", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 Do you want to close all open connections? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to reset the panels to their default layout? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connect in fullscreen mode 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Protocol Event Connected 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection to &quot;{0}&quot; via &quot;{1}&quot; established by user &quot;{2}&quot; (Description: &quot;{3}&quot;; User Field: &quot;{4}&quot;) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Protocol Event ErrorOccured 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection file path 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Opening connection failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot open connection: No hostname specified! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t set default port! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t create backup of connections file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t import connections file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections file &quot;{0}&quot; could not be loaded! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections file &quot;{0}&quot; could not be loaded!
        ///Starting with new connections file. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t save connections file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t save connections file as &quot;{0}&quot;! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connect without credentials 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connect to console session 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connect (with options) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection to {0} via {1} closed by user {2}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection to {0} via {1} closed by user {2}.  (Description: &quot;{3}&quot;; User Field: &quot;{4}&quot;) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection Event Closed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection Event Closed failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t create new connections file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Could not find ToolStrip control in FilteredPropertyGrid. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Create and open new file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Create an empty panel when mRemoteNG starts 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Credential Editor 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 In v1.76 we have introduced a credential management system. This feature requires a significant change in how we store and interact with credentials within mRemoteNG. You will be required to perform a one-way upgrade of your mRemoteNG connections file.
        ///
        ///This page will walk you through the process of upgrading your connections file or give you a chance to open a different connections file if you do not want to perform the upgrade. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Don&apos;t connect to console session 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Don&apos;t connect if authentication fails 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Double click on tab closes it 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Download and Install 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 DragDropSwitch 的本地化字符串。
        /// </summary>
        internal static string strDragDropSwitch {
            get {
                return ResourceManager.GetString("strDragDropSwitch", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Do you want to continue with no password? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 For empty Username, Password or Domain fields use: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 128-bit (logon only) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Completely encrypt connection file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Block Cipher Mode 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Encryption Engine 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Key Derivation Function Iterations 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 AddExternalToolsToToolBar (frmMain) failed. {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 AddFolder (UI.Window.ConnectionTreeWindow) failed. {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The database version {0} is not compatible with this version of {1}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 CloneNode (Tree.Node) failed . {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The connection list could not be saved. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 PuTTY could not be launched. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Decryption failed. {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Encryption failed. {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The Windows security setting, &quot;System cryptography: Use FIPS compliant algorithms for encryption, hashing, and signing&quot;, is enabled. 
        ///
        ///See the Microsoft Support article at http://support.microsoft.com/kb/811833 for more information.
        ///
        ///{0} is not fully FIPS compliant. Click OK to proceed at your own discretion, or Cancel to Exit. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The startup connection file could not be loaded.{0}{0}{2}{0}{3}{0}{0}In order to prevent data loss, {1} will now exit. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VerifyDatabaseVersion (Config.Connections.Save) failed. {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Expand all folders 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Export everything 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Export mRemote/mRemoteNG XML 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Export Properties 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Export the currently selected connection 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Export the currently selected folder 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 New External Tool 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Includes icons by [FAMFAMFAM] 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 http://www.famfamfam.com/ 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 All importable files 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Application Files (*.exe) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemote CSV Files (*.csv) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemote XML Files (*.xml) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 PuTTY Connection Manager files 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Remote Desktop Connection Manager files (*.rdg) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 visionapp Remote Desktop 2008 CSV Files (*.csv) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Could not find a credential record with ID matching &quot;{0}&quot; for the connection record named &quot;{1}&quot;. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Description of inherited property: {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Get Connection Info From SQL failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An error occured while loading the connection entry for &quot;{0}&quot; from &quot;{1}&quot;. {2} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Automatic Reconnect 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 External Tool Properties 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 HTTP Connect Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t create new HTTP Connection! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Changing HTTP Document Tile Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Internet Explorer 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Set HTTP Props failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Allow Insecure Certificate for URL: {0}? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Allow Insecure Certificate? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t create new ICA Connection! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Loading ICA Plugin failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ICA SetCredentials failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ICA Set Event Handlers Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ICA Set Props Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 ICA Set Resolution Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Identify quick connect tabs by adding the prefix &quot;Quick:&quot; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Import from Active Directory 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An error occurred while importing the file &quot;{0}&quot;. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Under the root{0}{1}|Under the selected folder{0}{2} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Where would you like the imported items to be placed? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Import mRemote/mRemoteNG XML 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Import from Port Scan 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Import from .RDP file(s) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemoteNG is up to date 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Dispose of Int App process failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Int App Focus Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Killing Int App Process failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Int App Resize failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Must Be Between 0 and 255 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 When closing connections: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 To configure PuTTY sessions click this button: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Maximum PuTTY and integrated external tools wait time: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Released under the GNU General Public License (GPL) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select a panel from the list below or click New to add a new one. Click OK to continue. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 {0} must be restarted before changes to the language will take effect. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Load from SQL failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The connection information could not be loaded from the SQL server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Load From XML failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Local file does not exist! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Lock toolbar positions 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Log these message types 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Log to application directory 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Writing to report file failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t save report to final location. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Uses the Magic library by [Crownwood Software] 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 http://www.dotnetmagic.com/ 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Add Connection Panel 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connection Panels 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections and Config 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Delete External Tool... 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Duplicate Connection 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 External Tools Toolbar 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Launch External Tool 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Multi SSH Toolbar 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 New Connection File 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Open Connection File... 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Quick Connect Toolbar 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Reconnect All Open Connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Refresh Screen (VNC) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Rename Connection 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Save Connection File 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Save Connection File As... 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Screenshot Manager 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Send Special Keys (VNC) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Sessions and Screenshots 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SmartSize (RDP/VNC) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SSH File Transfer 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Transfer File (SSH) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Minimize to notification area 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 My current credentials (Windows logon information) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This node is already in this folder. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot drag node onto itself. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot drag parent node onto child. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This node is not draggable. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 No Ext. App specified. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 You are trying to load a connection file that was created using an very early version of mRemote, this could result in an runtime error.
        ///If you run into such an error, please create a new connection file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Open a different file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Open new tab to the right of the currently selected tab 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Reset &amp;All to Default 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemoteNG Options 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Do you really want to delete the theme? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 No themes are loaded, check that the default mremoteNG themes exist in the &apos;themes&apos; folder 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot create theme, name already present or special characters in the name 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Type the new theme name 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Warning: Restart is required to disable the themes or to completely apply a new one 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Password must contain at least {0} of the following characters: {1} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Password must contain at least {0} lower case character(s) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Password must contain at least {0} number(s) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Password must contain at least {0} upper case character(s) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Password length must be between {0} and {1} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Both passwords must match. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The password must be at least 3 characters long. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Please fill all fields 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Port scan complete. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t load PortScan panel! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 (These properties will only be saved if you select mRemote/mRemoteNG XML as output file format!) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter the hostname or ip you want to connect to. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Toggle all inheritance options. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select which authentication level this connection should use. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select how you want to authenticate against the VNC server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether to automatically resize the connection when the window is resized or when fullscreen mode is toggled. Requires RDC 8.0 or higher. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether to use bitmap caching or not. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the colour quality to be used. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the compression value to be used. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select which credential to use for this connection. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Put your notes or a description for the host here. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select yes if the theme of the remote host should be displayed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select yes if the wallpaper of the remote host should be displayed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter your domain. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether to use desktop composition or not. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether to use font smoothing or not. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the encoding mode to be used. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the encryption strength of the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the external tool to be started. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select a external tool to be started after the disconnection to the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select a external tool to be started before the connection to the remote host is established. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose a icon that will be displayed when connected to the host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies the load balancing information for use by load balancing routers to choose the best server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter the MAC address of the remote host if you wish to use it in an external tool. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This is the name that will be displayed in the connections tree. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Sets the panel in which the connection will open. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter the port the selected protocol is listening on. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose the protocol mRemoteNG should use to connect to the host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select a PuTTY session to be used when connecting. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies the domain name that a user provides to connect to the RD Gateway server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies the host name of the Remote Desktop Gateway server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies when to use a Remote Desktop Gateway (RD Gateway) server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies whether or not to log on to the gateway using the same username and password as the connection. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Specifies the user name that a user provides to connect to the RD Gateway server. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether to receive an alert after the RDP session disconnects due to inactivity 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The number of minutes for the RDP session to sit idle before automatically disconnecting (for no limit use 0) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether local disk drives should be shown on the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether key combinations (e.g. Alt-Tab) should be redirected to the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether local ports (ie. com, parallel) should be shown on the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether local printers should be shown on the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select whether local smart cards should be available on the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select how remote sound should be redirected. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select one of the available rendering engines that will be used to display HTML. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose the resolution or mode this connection will open in. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the SmartSize mode to be used. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Choose the Sound Quality provided by the protocol: Dynamic, Medium, High 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connect to the console session of the remote host. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use the Credential Security Support Provider (CredSSP) for authentication if it is available. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Feel free to enter any information you need here. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 If you want to establish a view only connection to the host select yes. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter the proxy address to be used. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter your password for authenticating against the proxy. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter the port the proxy server listens on. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 If you use a proxy to tunnel VNC connections, select which type it is. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter your username for authenticating against the proxy. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Display Wallpaper 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Desktop Composition 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Encryption Strength 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 External Tool After 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 External Tool Before 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Load Balance Info 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Remote Desktop Gateway Password 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Gateway Credentials 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Alert on Idle Disconnect 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use Console Session 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Protocol Event Disconnected.
        ///Message:
        ///{0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Protocol Event Disconnected failed.
        ///{0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Protocol to import 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Proxy test failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Proxy test succeeded! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Dispose of Putty process failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t set focus! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Get Putty Sessions Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Killing Putty Process failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Putty Resize Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 PuTTY Saved Sessions 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 PuTTY Session Settings 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show PuTTY Settings Dialog failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Putty Start Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Quick Connect Add Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Creating quick connect failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 &amp;Warn me when closing connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Warn me only when e&amp;xiting mRemoteNG 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Warn me only when closing &amp;multiple connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Do &amp;not warn me when closing connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 16777216 Colours (24-bit) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 256 Colours (8-bit) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 32768 Colours (15-bit) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 16777216 Colours (32-bit) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 65536 Colours (16-bit) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP Add Resolution failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP Add Resolutions failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Add Session failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Close RDP Connection failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t create RDP control, please check mRemoteNG requirements. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Disable Cursor blinking 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Disable Cursor Shadow 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Disable Full Window drag 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Disable Menu Animations 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Disable Wallpaper 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP Disconnect failed, trying to close! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Internal error code 1. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Internal error code 2. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Internal error code 3. This is not a valid state. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Internal error code 4. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An unrecoverable error has occurred during client connection. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 GetError failed (FatalErrors) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An unknown fatal RDP error has occurred.  Error code {0}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 An out-of-memory error has occurred. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 A window-creation error has occurred. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Winsock initialization error. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t import rdp file! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RD Gateway is supported. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RD Gateway is not supported! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 GetSessions failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP Connection Timeout 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP reconnection count: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetAuthenticationLevel failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetUseConsoleSession failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Setting Console switch for RDC {0}. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetCredentials failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetEventHandlers failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetRDGateway failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetPerformanceFlags failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetPort failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetProps failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Rdp Set Redirection Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Rdp Set Redirect Keys Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP SetResolution failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Bring to this computer 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Leave at remote computer 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP ToggleFullscreen failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 RDP ToggleSmartSize failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Reconnect All Connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Reconnect to previously opened sessions on startup 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Do you want to save the current connections file before loading another? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Save connections on exit 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Graphics Interchange Format File (.gif)|*.gif|Joint Photographic Experts Group File (.jpeg)|*.jpeg|Joint Photographic Experts Group File (.jpg)|*.jpg|Portable Network Graphics File (.png)|*.png 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Get Sessions Background failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Kill Session Background failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Set hostname like display name when creating or renaming connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Setting main form text failed 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Couldn&apos;t save settings or dispose SysTray Icon! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show description tooltips in connection tree 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show full connections file path in window title 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show logon information on tab names 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show on toolbar column 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show protocols on tab names 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show these message types 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Single click on connection opens it 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Single click on opened connection in Connection Tree switches to opened Connection Tab 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Please see Help - Getting started - SQL Configuration for more Info! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SQL Update check finished and there is an update available! Going to refresh connections. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SSH background transfer failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Transfer successful! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SSH Transfer End (UI.Window.SSHTransfer) failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 SSH transfer failed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Switch to Notifications panel on: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections Panel 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the config panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the category text in the config panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the grid lines in the config panel 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the help area of the config panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the help area of the config panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the config panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the connections panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the connections panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the tree lines in the connections panel. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the menus. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the menus. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the search box. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the search box. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the prompt text in the search box. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the toolbars. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The colour of the text in the toolbars. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The background colour of the main window. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Category Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Grid Line Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Help Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Help Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Config Panel Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections Panel Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections Panel Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Connections Panel Tree Line Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Menu Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Search Box Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Search Box Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Search Box Text Prompt Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Toolbar Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Toolbar Text Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Window Background Colour 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Ultra VNC Repeater 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 UltraVNC SingleClick port: 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 UltraVNC SingleClick 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Uncheck the properties you want not to be saved! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemoteNG requires an update 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemoteNG can periodically connect to the mRemoteNG website to check for updates. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The update information could not be downloaded. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 mRemoteNG Portable Edition does not currently support automatic updates. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Download complete!
        ///mRemoteNG will now quit and begin with the installation. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The update could not be downloaded. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The update download could not be initiated. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The change log could not be downloaded. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use AdmPwd.E to retrieve the password 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use a different username and password 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use the same username and password 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Use SQL Server to load &amp;&amp; save connections 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC disconnect failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Refresh Screen Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC SendSpecialKeys failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Set Event Handlers failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Set Props Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Start Chat Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Toggle SmartSize Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 VNC Toggle ViewOnly Failed! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Warn me if authentication fails 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Uses the DockPanel Suite by [Weifen Luo] 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 http://sourceforge.net/projects/dockpanelsuite/ 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Testing connection 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Unlock Credential Repository 的本地化字符串。
        /// </summary>
